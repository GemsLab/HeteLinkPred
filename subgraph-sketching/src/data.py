...
def get_amazon_computer_data(args, device, dataset_root):
    print("Get Grid Data")
    g = dgl.load_graphs(dataset_root+"AmazonComputer-train.dgl")[0][0]
    g = g.to('cpu')
    g, reverse_eids = to_bidirected_with_reverse_mapping(g)
    reverse_eids = reverse_eids.to(device)
    
    split_edges = torch.load(dataset_root+"AmazonComputer-train-split.pt")
...
def get_amazon_computer_loaders_BUDDY(args, dataset, device, splits, directed=False):
    print("Getting Dataloader")
...
def get_custom_data(args, device, dataset_root, name):
    print("Get Grid Data")
    g = dgl.load_graphs(dataset_root+ name + "-train.dgl")[0][0]
    g = g.to('cpu')
    g, reverse_eids = to_bidirected_with_reverse_mapping(g)
    reverse_eids = reverse_eids.to(device)
    
    split_edges = torch.load(dataset_root+ name +"-train-split.pt")
...
def get_custom_loaders_BUDDY(args, dataset, name, splits, directed=False):
    print("Getting Dataloader")
