...
from src.data import get_amazon_computer_data, get_amazon_computer_loaders_BUDDY, get_custom_data, get_custom_loaders_BUDDY, get_data, get_esci_data
...
if __name__ == '__main__':
  ...
  parser.add_argument('--dataset_name', type=str, default='Cora',
                      choices=['Cora', 'producer', 'Citeseer', 'Pubmed', 'ogbl-ppa', 'ogbl-collab', 'ogbl-ddi',
                               'ogbl-citation2', 'grid', 'esci', 'amazon-computer', "attributed-facebook", "attributed-ppi"])
