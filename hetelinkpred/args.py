...
def get_args():
    ...
    parser.add_argument("--model_name", default='SAGE', 
                        choices=['SAGE', 'SAGE_DOT', 'SAGE_DistMultS', 'GCN', 'GCN_DOT', 'GCN_DistMultS',
                                 'GAT', 'GIN', 'MLPDecoder', 'DistMultSDecoder', 'GPRGNN', 'GPRGNN_DOT', 'GPRGNN_DistMultS'],
    ...
    parser.add_argument("--dataset", default='ogbl-citation2',
                        choices=['ogbl-citation2', 'ogbl-collab', 'USAir', 'esci', 
                                 'ogbl-collab_low_degree', 'grid', 'grid-dense', 'amazon-computer', 
                                 "attributed-ppi", "attributed-facebook"],
    ...
    parser.add_argument('--alpha', type=float, default=0.1, help='The alpha parameter for GPRGNN.')
...
def get_output_name(args, run=None):
    ...
    if args.model_name.startswith("GPRGNN"):
